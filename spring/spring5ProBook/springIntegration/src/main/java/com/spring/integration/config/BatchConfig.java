...
import com.spring.integration.Singer;
import com.spring.integration.SingerItemProcessor;
import com.spring.integration.StepExecutionStatsListener;
...
public class BatchConfig {
    ...
    public ItemWriter<Singer> itemWriter() {
        ...
        itemWriter.setSql("INSERT INTO spring5probook.singer (singer_id, first_name, last_name, song) " +
                "VALUES (:id, :firstName, :lastName, :song)");
        return itemWriter;
    }
