package info.vladyslav.codeLibrary.u02jdbc;
...
public class CitiesJdbcDemo {
     ...
     */
//    static final String JDBC_DRIVER = "com.mysql.cj.info.vladyslav.codeLibrary.u02jdbc.Driver"; // устарело лет 10-15 назад

    // ниже обязательно добавляем тайм-зону для SQL сервера → ?serverTimezone=EST5EDT
    static final String DATABASE_URL = "u02jdbc:mysql://localhost/world?serverTimezone=EST5EDT";
